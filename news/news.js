jQuery(document).ready(function() {
    ...
    var data=[
        {image:'../assets/images/news/20171004-1.jpg',position_x:'0px',position_y:'-5px',date:'2017-10-04',title:'中秋国庆双双庆 月圆人圆事事圆',content:'感谢您一直以来对云核网络的支持！在国庆中秋双节到来之际，云核网络祝愿您：中秋国庆双双庆，月圆人圆事事圆。'},
        {image:'../assets/images/news/20170707.jpg',position_x:'0px',position_y:'-50px',date:'2017-07-07',title:'祭奠同胞 勿忘国耻',content:'七七事变七十周年 祭奠同胞 勿忘国耻'},
        {image:'../assets/images/news/20170211.jpg',position_x:'0px',position_y:'-108px',date:'2017-02-11',title:'闹元宵 猜灯谜',content:'元宵节，又称小正月、元夕或灯节，是春节之后的第一个重要节日。其中吃元宵、舞龙舞狮、赏花灯、猜灯谜等狮元宵节几项重要民间习俗。在此，云核网络恭祝全体员工以及广大新老客户元宵佳节快乐！ '},
        {image:'../assets/images/news/20170128.jpg',position_x:'0px',position_y:'-8px',date:'2017-01-28',title:'新年开鸿运',content:'云核网络祝您鸡年大吉！'},
        {image:'../assets/images/news/news_2_2.jpg',position_x:'0px',position_y:'-254px',date:'2017-01-11',title:'感谢有你.共同成长----云核网络2016年度优秀员工表彰大会成功落幕',content:'2017年1月7-8日，云核网络2016年度优秀员工表彰大会在南京顺利召开。会议中，总经理戴林巧先生做了精彩致辞，副总经理罗勇先生进行了年度工作总结报告！'},
        {image:'../assets/images/news/news_3.jpg',position_x:'0px',position_y:'-104px',date:'2016-12-02',title:'三省吾身，厚积薄发 —热烈祝贺云核网络成立三周年',content:'一个品牌的声誉与成功绝非只有偶然，只有历经客户的认可，才能赢得市场。云核网络，2013年仅仅还是进入国内金融服务行业中的新兵，三年时间，稳扎稳打，潜心抓产品质量与服务意识，赢得了客户的认可和赞赏，在行业内取得了不俗的成绩，收获了一个又一个丰硕成果。'},

        {date:'2016-11-22',title:'云核网络承建深圳农商银行信用卡手机银行项目',content:'云核网络承建的深圳农村商业银行信用卡手机银行系统项目为满足多平台用户的需要、提升用户体验主要涉及venus-native-iphone、venus-native-android、venus-h5三个客户端框架的开发，整个项目将分为三期逐步实现建设目的。截止发稿日，该项目已进入三期建设阶段，已上线的系统运行平稳，得到深圳农商银行领导的一致认可。'},
        ...
        {image:'../assets/images/news/news_11.png',position_x:'0px',position_y:'0px',date:'2016-09-12',title:'2016中秋快乐'},
        ...
        {image:'../assets/images/news/news_18_1.png',position_x:'0px',position_y:'0px',date:'2016-01-16',title:'云核网络2015年“感谢有你 · 共同成长”主题年会圆满结束',content:'云核网络2015年“感谢有你·共同成长”主题年会于2016年1月10日在无锡太湖风景区圆满结束，会议中云核网络公司总经理戴林巧先生致辞，副总经理罗勇先生做2015年度工作总结报告，同时本次年会还对2015年度优秀员工进行了表彰。'},
        {image:'../assets/images/news/news_19.jpg',position_x:'0px',position_y:'0px',date:'2016-01-09',title:'感谢有你 · 共同成长 ——暨云核网络2015年员工表彰大会如期召开',content:'  云核网络2015年员工表彰大会于2016年1月9日在无锡太湖顺利召开，根据前期优秀员工评选活动，本次共产生10名优秀员工。'},
        {image:'../assets/images/news/news_22.jpg',position_x:'0px',position_y:'0px',date:'2015-12-16',title:'云核网络与昆山农商银行建立战略合作伙伴关系'},
        ...
        {image:'../assets/images/news/news_70.jpg',position_x:'0px',position_y:'0px',date:'2011-11-10',title:'我公司总经理戴林巧在中国银行业信息科技风险管理2011年会上作主题演讲',content:'2011年11月8日，我公司总经理戴林巧先生在中国银行业信息科技风险管理2011年会上作“网上银行暨电子银行安全风险防控”主题演讲 。'},
        ...
        if($('.grid-item').length){
            ...
            if (scrollTop + windowHeight >= scrollHeight-80 && n<=max){
                ...
                for(var i=6*n-6;i<len;i++){
                    var cur=data[i];
                    var href='newsDet_'+(i+7)+'.html';
                    if(cur.image&&cur.content){
                        var imageUrl=cur.image;
                        html+='<div class="grid-item news-topDate" onclick="location.href=\''+href+'\'">' +
                            '               <div> <div style="background: url('+imageUrl+');width: 314px;height:180px;background-size: cover;background-position: '+cur.position_x+' '+cur.position_y+'"></div></div>' +
                            '                <p>' +
                        ...
                        html+='<div class="grid-item" onclick="location.href=\''+href+'\'">' +
                            '                <p>' +
                            '                    <b>'+cur.date.substr(8,2)+'</b>' +
                            '                    <span>/'+cur.date.substr(5,2)+'&nbsp;'+cur.date.substr(0,4)+'</span>' +
                            '                </p>' +
